using AutoMapper;
using mangos.services.ShoppingCartAPI;
using mangos.services.ShoppingCartAPI.Data;
using mangos.services.ShoppingCartAPI.services;
...
builder.Services.AddHttpClient("Coupan", u => u.BaseAddress = new Uri(builder.Configuration["ServiceUrls:CoupanApi"]));
